...
function prepareCheckout() { $('#checkoutForm').hidden = false; $('#orderSuccess').hidden = true; $('#orderSuccess').innerHTML = ''; $('#checkoutTotal').textContent = money(cartSubtotal() + (store.deliveryFee || 0)); $('#addressField').hidden = $('#fulfillmentInput').value !== 'delivery'; $('#fulfillmentInput').value = 'delivery'; $('#addressField').hidden = false; $('#pixPaymentBox').hidden = true; openModal('checkoutModal'); }
